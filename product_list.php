      ...
      <body>
            <main>
                  <section class="d-flex flex-row w-100">
                        <div
                              class=" side_nav d-flex flex-column flex-shrink-0 back_ground_color"
                              style="width: 4.5rem"
                        >
                              <a
                                    href="/"
                              ...
                              <div class="dropdown border-top">
                                    <button
                                          type="button"
                                          class="btn btn-primary logout_btn"
                                    >
                                          LOGOUT
                                    </button>
                              </div>
                  ...
                  <!-- Search bar -->
                                    ...
                                    <!-- Modal section -->
                                    <button id="add_btn" type="button" type="button" class="btn" data-bs-toggle="modal" data-bs-target="#product_modal">
                                        ADD
                                    </button> 
                                </div>
                                    </div>
                                    <div class="modal fade" id="product_modal" tabindex="-1" aria-labelledby="product_modal_label" aria-hidden="true">
                                                ...
                                                <tbody>
                                                      ...
                                                      ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['ID']+12;?></td>
                                                            <td><?php echo $row['Price'];?></td>
                                                            <td><?php echo $row['Names']; ?></td>
                                                            <td><?php echo $row['Quantity']; ?></td>
                                                            <td><a class="edit_btn">EDIT</a> <a class="delete_btn">DELETE</a></td>
                                                        </tr>
                                                      <?php endwhile; ?>  
                                                </tbody>
                                            </table>
